 ...
 *
 * 输入：words = ["hello","ming.leetcode"], order = "hlabcdefgijkmnopqrstuvwxyz"
 * 输出：true
...
public class Leetcode953 {
    public static void main(String[] args) {
        ...
        boolean hlabcdefgijkmnopqrstuvwxyz = a.isAlienSorted(new String[]{"hello", "ming/leetcode"}, "hlabcdefgijkmnopqrstuvwxyz");
        System.out.println();
    }
